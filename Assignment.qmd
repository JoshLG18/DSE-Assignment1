...
plt.figtext(0.5, 0.03, "Figure 1: Box Plot of Healthcare Spend Per Capita (USD)", ha="center", fontsize=11)
plt.show()

plt.figure(figsize=(10, 4))
sns.histplot(cleaned_data["Heathcare Expenditure (USD)"], bins=30, kde=True, color='blue')
plt.figtext(0.5, -0.06, "Figure 2: Histogram with Density of Healthcare Spend Per Capita (USD)", ha="center", fontsize=11)
plt.xlabel("Healthcare Spend Per Capita (USD)")
plt.show()
```
...
**Link to GitHub Repository = https://github.com/JoshLG18/DSE-Assingment**