...
missing_values_table = pd.DataFrame({
    ...
    'Missing Observations (%)': [((missing_values_Health / len(Health_Data_long)) *100).round(1), ((missing_values_Infant / len(Infant_Data_long)) *100).round(1)]
})
```
...
latex_table = missing_values_table.to_latex(index=False,
                                            ...
                                            label="Table 3:missings",
                                            column_format="|l|r|r|",
                                            escape=False)

# Ensure correct LaTeX table format
latex_table = latex_table.replace("\\begin{table}", "\\begin{table}[H]")


# Save the modified LaTeX table
